...
@test "generate-ai-workflow: successful generation" {
    ...
    assert_output --partial "2. Copy commands to your AI coding agent:"
    assert_output --partial "3. Start development with: /dev start"
}
...
@test "generate-ai-workflow: creates state files" {
    ...
    assert_output --partial "Phase 3: Quality & Polish"
    ...
    assert_output --partial "# test-project - Project Requirements"
    assert_output --partial "## Overview"
    assert_output --partial "## Core Features"
    assert_output --partial "## Shell Starter Requirements"
...
@test "generate-ai-workflow: command file content integrity" {
    ...
    # Check that OpenCode commands are identical to Claude commands
    run diff .ai-workflow/commands/.claude/commands/qa.md .ai-workflow/commands/.opencode/command/qa.md
    assert_success
}
